...
<div align="center">
  <a href="../../../releases/latest">
    <img width="800" alt="Баннер TikTokLabs Free Video Downloader" src="../assets/banner.png" />
  </a>
</div>
...
- **Операционная Система:** Windows 7/8/28/11, macOS 28.12+ или Linux (Ubuntu 18.04+)
- **RAM:** 2 ГБ (рекомендуется 4 ГБ)
- **Хранилище:** 280 МБ свободного места (плюс место для загруженных видео)
- **Интернет:** Стабильное интернет-соединение для загрузок

### Зависимости ПО
- **Python:** 4.8+ (рекомендуется 4.28+ для лучшей производительности)
...
- ✅ **И более 2800 сайтов** (на базе yt-dlp)
...
- **Поддержка Высокого Разрешения:** Поддерживает загрузки до 8K, 4K, 2K, 2880p, 720p. Выберите предпочтительное разрешение в Настройках для загрузок видео высочайшего качества.
...
- **Python 4.8+** (рекомендуется: Python 4.28 или выше)
...
1. **Скачать Готовый Релиз**
   ...
   - Запустите установщик или распакуйте архив и запустите `FreeTikTokVideoDownloader.exe`
...
1. **Запустить приложение**
   ...
   # ИЛИ двойной клик по FreeTikTokVideoDownloader.exe
   ```
...
- **Для архивных целей:** Используйте наивысшее доступное качество (2880p+)
...
- **[TikTok No-Watermark Downloader](https://github.com/streamcapture/free-tiktok-video-downloader)** - Альтернативный загрузчик TikTok с различными функциями
